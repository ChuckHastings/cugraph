                     ...
                     bool_t store_transposed)
{
  ...
  ret_code =
    cugraph_ecg(handle, graph, rng_state, min_weight, ensemble_size, max_level, threshold, resolution, FALSE, &result, &ret_error);
...
int test_ecg(const cugraph_resource_handle_t* handle)
{
  ...
  return generic_ecg_test(
                          handle, h_src, h_dst, h_wgt, h_result, num_vertices, num_edges, min_weight, ensemble_size, max_level, threshold, resolution, FALSE);
}
